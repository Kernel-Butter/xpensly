...
import { ArrowLeft, Plus, Ruler, Sprout, X, MapPin } from 'lucide-react'
...
export default function FieldsPage() {
  ...
  function handleSave() {
    if (!fieldName.trim() || !activeBusiness) return
    createContext(
      {
      ...
      <main className="mx-auto w-full max-w-2xl px-4 pt-4 flex flex-col gap-4 pb-24">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-3 py-16 text-center">
            ...
            <p className="text-body-sm text-on-surface-variant opacity-60">Tap Add to define your first field</p>
          </div>
        ) : (
