...
import { ArrowLeft, Plus, Check, Building2, ChevronRight, Loader2 } from 'lucide-react'
      ...
      >
        ...
        {step === 1 && (
          <>
            ...
            <button
              onClick={() => setStep(2)}
              className="w-full rounded-xl bg-primary py-3.5 text-title-md text-on-primary active:scale-[0.98] transition-all"
            >
              Continue
            </button>
          </>
        ...
        {step === 2 && (
          <>
            ...
            <p className="text-body-sm text-on-surface-variant">
              Give your{' '}
              <span className="font-medium text-on-surface capitalize">{bType}</span> business a name.
            </p>
            <div className="flex flex-col gap-1.5">
              <label className="text-body-sm text-on-surface-variant">Business Name</label>
              <input
                value={bName}
                onChange={(e) => { setBName(e.target.value); setNameError('') }}
